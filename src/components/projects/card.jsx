    ...
    return (
        ...
        >
            ...
            <div className="float-end p-6 pt-1 grid grid-cols-2 gap-5">
                <a
                    href={data.live}
                    className="text-center py-1 text-white bg-lime-600 rounded-md hover:opacity-80 hover:scale-105 overflow-hidden  "
                >
                    <i className="ri-arrow-right-up-box-line mr-1"></i> Live Site
                </a>
                <a
                    href={data.github}
                    className="text-center py-1 text-white bg-teal-700 rounded-md hover:opacity-80 hover:scale-105 overflow-hidden "
                >
