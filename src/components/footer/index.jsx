...
const Footer = () => {
  ...
  return (
    ...
    >
      ...
      <ul className="flex justify-center items-center space-x-3 h-10">
        {SocialLinks?.map((item) => (
          <li key={item.href} className="w-10">
      ...
      <div className="mt-4 text-base text-center">
        Website by{" "}
        <a
          to="https://github.com/Ammar-Amin"
          target="_blank"
