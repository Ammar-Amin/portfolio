...
const Footer = () => {
    const [dark] = useDark()
    return (
        <footer className={'px-5 py-10 ' + (dark ? "text-gray-400" : "text-gray-800")}>
            <div className="w-full max-w-7xl mx-auto sm:flex sm:items-center sm:justify-between">
                <a href="#" target="_blank" className="flex items-center mb-4 sm:mb-0">
                    <svg version="1.1" viewBox="0 0 2048 1509" className='w-14 md:w-24 h-14 md:h-24' fill={dark ? "white" : "black"} xmlns="http://www.w3.org/2000/svg">
                ...
                <ul className="flex flex-wrap items-center mb-6 sm:mb-0">
                    <li>
                        <a href="#" className="mr-4 text-sm hover:underline md:mr-6">About</a>
                    </li>
                    <li>
                        <a href="#" className="mr-4 text-sm hover:underline md:mr-6">Privacy
                            Policy</a>
                    </li>
                    <li>
                        <a href="#"
                            className="mr-4 text-sm hover:underline md:mr-6">Licensing</a>
                    </li>
                    <li>
            ...
            <div className='mt-4 text-base text-center'>Website by <a to='https://github.com/Ammar-Amin' target="_blank" className='underline cursor-pointer font-medium'>Ammar-Amin</a></div>
            <hr className="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8" />
            <span className="block text-sm sm:text-center">© 2022 <a href="https://github.com/Ammar-Amin" target="_blank" className="hover:underline">Ammar™</a>. All Rights Reserved.
            </span>
        </footer>
    )
}
