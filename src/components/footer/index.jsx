...
const Footer = () => {
    ...
    return (
        <footer className={'px-5 py-10 ' + (dark ? "text-gray-400" : "text-gray-800")}>
            <div class="w-full max-w-7xl mx-auto sm:flex sm:items-center sm:justify-between">
                ...
                <ul class="flex flex-wrap items-center mb-6 sm:mb-0">
                    <li>
                        <a href="#" class="mr-4 text-sm hover:underline md:mr-6">About</a>
                    </li>
                    <li>
                        <a href="#" class="mr-4 text-sm hover:underline md:mr-6">Privacy
                            Policy</a>
                    </li>
                    <li>
                        <a href="#"
                            class="mr-4 text-sm hover:underline md:mr-6">Licensing</a>
                    </li>
                    <li>
            ...
            <span class="block text-sm sm:text-center">© 2022 <a href="https://github.com/Ammar-Amin" target="_blank" class="hover:underline">Ammar™</a>. All Rights Reserved.
            </span>
        </footer>
    )
}
