...
export const clones = [
    {
        title: "Qid Clone",
        img: qid,
        desc: "Completed a website clone assignment in 3 days, replicating the whole website of a prominent platform.",
        skills: ["React", "TailwindCSS", "ReactRouterDom"],
        live: "https://qid-ui-by-ammar.vercel.app/",
        github: "https://github.com/Ammar-Amin/qid-ui"
    },
    {
        title: "LU.MA Replica",
        img: luma,
...
export const basic = [
    ...
    },
    {
        ...
        img: radiant,
        desc: "Successfully completed an assignment form Radiant Riches, ui clone for page builders website",
        skills: ["React", "TailwindCSS"],
        live: "https://main--ammar-amin-radiant-riches.netlify.app/",
        github: "https://github.com/Ammar-Amin/Internship-Assignment-Radiant-Riches-LCC"
    },
]
